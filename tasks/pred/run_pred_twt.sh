...
BASE_DATASET="totto"
MASK_PATTERN="random"
BASE_MODEL="bert2bert"
MODEL_SIZE="base"
CUSTOM_MODEL="_twt"
CUSTOM_SETTINGS="_0.4_gen_loss"
BEST_CHECKPOINT="checkpoint-24000"

TOKENIZER_NAME="bert-${MODEL_SIZE}-uncased"
...
LOCAL_DEVIDED_OUTPUT_DIR=${LOCAL_TEMP_DIR}/devided_output/${EXPERIMENT_NAME}
...
python -u run_distributed_eval.py \
  ...
  --model_type="${CUSTOM_MODEL:1}_${BASE_MODEL}" \
