...
class BartSeq2Seq(object):
    ...
    def _init_model(self):
        ...
        bart_model = BartForConditionalGeneration.from_pretrained(f"facebook/bart-{self.args.model_size}", output_attentions=True, output_hidden_states=True)
...
def parse_args():
    ...
    parser.add_argument("--train_model_inputs_file",
                        type=str,
                        default="./data/cache/twt/totto_random_causal_bart_base_train_model_inputs.pkl.gz",
                        help="Path of the train file")
    parser.add_argument("--train_linearized_model_inputs_file",
                        type=str,
                        default="./data/cache/twt/totto_random_linearized_bart_base_train_model_inputs.pkl.gz",
                        help="Path of the train file")
    parser.add_argument("--val_model_inputs_file",
                        type=str,
                        default="./data/cache/twt/totto_random_causal_bart_base_dev_model_inputs.pkl.gz",
                        help='Path of the validation file')
    parser.add_argument("--val_linearized_model_inputs_file",
                        type=str,
                        default="./data/cache/twt/totto_random_linearized_bart_base_dev_model_inputs.pkl.gz",
                        help='Path of the validation file')
